...
class ConfirmEmail(AuthView):
    def handle(self, request, helper):
        ...
        return self.respond("github/enter-email.html", {"form": form})
...
class SelectOrganization(AuthView):
    ...
    def handle(self, request, helper):
        ...
        return self.respond("github/select-organization.html", {"form": form, "org_list": org_list})


class GitHubConfigureView(ConfigureView):
    def dispatch(self, request, organization, auth_provider):
        return self.render("github/configure.html")
